"""
Django settings for appsae project.

Generated by 'django-admin startproject' using Django 4.1.2.

For more information on this file, see
https://docs.appsae.com/en/4.1/topics/settings/

For the full list of settings and their values, see
https://docs.appsae.com/en/4.1/ref/settings/
"""
import os
...
# https://docs.appsae.com/en/4.1/ref/settings/#default-auto-field
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'eat_advisor@outlook.fr'
